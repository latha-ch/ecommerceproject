...
SECRET_KEY = 'django-insecure-h0u6f+9rj#6*a@lr9=_da#r^4t3a5rzel*l4bq^duq_l*_0dg%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
EMAIL_USE_TLS=True
EMAIL_HOST='smtp.gmail.com'
EMAIL_HOST_USER='sailokesh117@gmail.com'
EMAIL_HOST_PASSWORD ='apqysqpnlytygccm'
EMAIL_PORT=587
ALLOWED_HOSTS = []
